...
uint8_t InstructionSubBase::Acquire8bitSourceOperandValue(RegisterBankInterface* registerBank, DecodedInstruction& decodedInstruction)
{
...
uint16_t InstructionSubBase::Acquire16bitSourceOperandValue(RegisterBankInterface* registerBank, DecodedInstruction& decodedInstruction)
{
    return registerBank->ReadPair(decodedInstruction.SourceRegister);
}

uint8_t InstructionSubBase::CalculateBinarySubtractionAndSetFlags(uint8_t operand1, uint8_t operand2, optional<uint8_t> borrow, RegisterBankInterface* registerBank)
{
