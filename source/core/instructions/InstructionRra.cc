...
void InstructionRra::Execute(RegisterBankInterface* registerBank, DecodedInstruction& decodedInstruction)
{
...
inline void InstructionRra::SetFlags(RegisterBankInterface* registerBank, uint8_t flagValue)
{
