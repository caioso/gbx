...
void InstructionAdc::Decode(uint8_t opcode, [[maybe_unused]] optional<uint8_t> preOpcode, DecodedInstruction& decodedInstruction)
{
...
void InstructionAdc::Execute(interfaces::RegisterBankInterface* registerBank, DecodedInstruction& decodedInstruction)
{
