...
INCLUDE = -I$(INCLUDE_TOP) -I$(INCLUDE_CORE_TOP) -I$(INCLUDE_CORE_CONSTANTS) \
		  ...
		  -I$(INCLUDE_DEBUGGER_TRANSPORT) -I$(INCLUDE_DEBUGGER_ALGORITHMS)
...
-include $(DEP_FILES)
$(TARGET): $(TARGET_SOURCE) $(CORE_LIB) $(COMMONS_LIB) $(RUNTIME_LIB) $(DEBUG_LIB)
	$(CC) -MMD -MT"$@" -MF"$(DEP_FILES)" $(INCLUDE) $(TARGET_SOURCE) $(CPPFLAGS) -o $(TARGET) $(CORE_LIB) $(DEBUG_LIB) $(COMMONS_LIB) $(RUNTIME_LIB) $(LDFLAGS)