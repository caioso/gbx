...
INCLUDE = -I$(INCLUDE_EMULATOR_TOP) -I$(INCLUDE_DEBUGGER_TOP) -I$(INCLUDE_DEBUGGER_INTERFACES) \
		  -I$(INCLUDE_DEBUGGER_PROTOCOL) -I$(INCLUDE_EMULATOR_RUNTIME) -I$(INCLUDE_DEBUGGER_TRANSPORT) \
