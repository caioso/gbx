...
public:
    ...
    void RegisterMemoryResource(std::shared_ptr<interfaces::MemoryInterface>, AddressRange,  Ownership) override;
    void UnregisterMemoryResource(std::shared_ptr<interfaces::MemoryInterface>, Ownership) override;
