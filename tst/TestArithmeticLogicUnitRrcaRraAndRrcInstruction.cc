...
TEST(TestRrcaRraAndRrc, DecodeRrcaRegisterMode)
{
...
TEST(TestRrcaRraAndRrc, ExecuteRrcaRegisterMode)
{
    auto registerBank = make_shared<RegisterBank>();
...
TEST(TestRrcaRraAndRrc, DecodeRraRegisterMode)
{
    auto registerBank = make_shared<RegisterBank>();
...
TEST(TestRrcaRraAndRrc, ExecuteRraRegisterMode)
{
    auto registerBank = make_shared<RegisterBank>();
...
TEST(TestRrcaRraAndRrc, DecodeRrcRegisterMode)
{
    auto registerBank = make_shared<RegisterBank>();
