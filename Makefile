...
coverage:
	xcrun llvm-profdata merge -o gbxdbTestCoverage default.profraw
	xcrun llvm-cov report gbxdbTest -instr-profile=gbxdbTestCoverage -use-color --ignore-filename-regex="(gtest|gmock)" --ignore-filename-regex="(Test(.*)\.cc)"
