...
INCLUDE_CORE_MEMORY_REGISTERS = $(INCLUDE_CORE_MEMORY)/registers
INCLUDE_CORE_VIDEO = $(INCLUDE_CORE_TOP)/video
...
export INCLUDE_CORE_MEMORY_REGISTERS
export INCLUDE_CORE_VIDEO
...
ifeq ($(word 2,$(ARGS)), $(RUNTIME_TESTS_FLAG))
	./build/test/gbxtest $(TEST_DATA) --gtest_filter="RuntimeTests_*" 
else
