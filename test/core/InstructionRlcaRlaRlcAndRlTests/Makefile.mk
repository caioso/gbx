...
INCLUDE = -I$(INCLUDE_CORE_TOP) -I$(INCLUDE_CORE_INSTRUCTIONS) -I$(INCLUDE_CORE_INTERFACES) -I$(TEST_UTILS) 
...
MODULES = MemoryController RegisterBank ArithmeticLogicUnit InstructionRet \
		  InstructionRl InstructionRlc InstructionRla InstructionRlca
