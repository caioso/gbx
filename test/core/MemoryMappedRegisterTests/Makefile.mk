...
INCLUDE = -I$(INCLUDE_CORE_TOP) -I$(INCLUDE_CORE_INSTRUCTIONS) -I$(INCLUDE_CORE_MEMORY) -I$(INCLUDE_CORE_MEMORY_REGISTERS) -I$(INCLUDE_CORE_INTERFACES) -I$(TEST_UTILS)
...
MODULES = MemoryController AddressRange InterruptEnableRegister
