...
INCLUDE = -I$(INCLUDE_CORE_TOP) -I$(INCLUDE_CORE_INSTRUCTIONS) -I$(INCLUDE_CORE_MEMORY) -I$(INCLUDE_CORE_INTERFACES) -I$(INCLUDE_COMMONS_TOP) -I$(TEST_UTILS) 
...
MODULES = GBXCoreExceptions BankedROM FileLoader
