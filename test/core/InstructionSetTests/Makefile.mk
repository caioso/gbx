...
INCLUDE = -I$(INCLUDE_CORE_TOP) -I$(INCLUDE_CORE_INSTRUCTIONS) -I$(INCLUDE_CORE_INTERFACES) -I$(TEST_UTILS) -I$(INCLUDE_CORE_MEMORY) -I$(INCLUDE_CORE_MEMORY)
...
MODULES = MemoryController RegisterBank ArithmeticLogicUnit InstructionSet
