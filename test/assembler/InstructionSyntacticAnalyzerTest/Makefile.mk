...
INCLUDE = -I$(INCLUDE_ASSEMBLER_TOP) -I$(INCLUDE_ASSEMBLER_FRONTEND_TOP) -I$(INCLUDE_ASSEMBLER_FRONTEND_PARSERS) \
		  ...
		  -I$(INCLUDE_ASSEMBLER_STREAMS) -I$(INCLUDE_ASSEMBLER_UTILITIES) -I$(TEST_UTILS) -I$(INCLUDE_CORE_INSTRUCTIONS)
...
MODULES = LexicalAnalyzer GBXAsmExceptions Construction InstructionSyntacticAnalyzer InstructionIntermediateRepresentation
